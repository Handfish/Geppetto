...
export class ProviderFeatureUnsupportedError extends Data.TaggedError('ProviderFeatureUnsupportedError')<{
  provider: ProviderType
  feature: string
}> {}
...
export class ProviderRepositoryError extends Data.TaggedError('ProviderRepositoryError')<{
  provider: ProviderType
  message: string
}> {}
