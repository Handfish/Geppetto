 ...
 * It can be replaced with a real implementation when Bitbucket integration is ready.
 */

// Register the provider tag
const BitbucketProviderTag = VcsProviderTags.register(PROVIDER)
...
/**
 * Stub implementation of Bitbucket provider adapter as a Layer.
 * This Layer provides the VcsProviderPort for Bitbucket (stub).
 */
export const BitbucketBrowserProviderAdapter = Layer.succeed(
  BitbucketProviderTag,
  {
    provider: PROVIDER,
